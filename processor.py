...
def process(file_path, criteria):
	...
	for r in results:
		...
		worksheet.conditional_format(1,1,df.y.max()+1,df.x.max()+1, {'type': 'cell', 'criteria':'not between', 'minimum':-criteria[r], 'maximum':criteria[r], 'format':format1})
